...
def start():
    ...
    print("TG防撞客机器人 V2.0.2 PLACEHOLDER-GUARD TEMPLATE-ID-GUARD CLEAN-ENTRY-REPLY PRECHECKED-NEW DIRECT-ENTRY AUTO-FIND-IMAGE EDITED-CAPTION-ENTRY REVIEW-FIX MATCH-PREVIEW SAFE-MATCH SSCD-AI COPY-GUARD AUTO90 GitHub + Railway 启动（群聊专用 / 私聊关闭）")
    app.run_polling(
